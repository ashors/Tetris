...
public class shape2 extends shapes {
	...
	public void draw(Graphics g) {
		g.setColor(new Color(116, 101, 243));
	...
	@Override
	public void update() {
		if (rect1.x < rect3.x && rect4.y > 550 || rect1.y < rect2.y && rect3.y > 550 ||
				rect1.x > rect2.x && rect1.y > 550 || rect1.y > rect2.y && rect1.y > 550 /* or hits another block*/) {
			moving = false; // this only works in some of the orientations
		}
		if (moving == true) {
			//y += 50;
			rect1.y += 50;

...
public class shape3 extends shapes {
	...
	public shape3() {
		...
		rect2 = new Rectangle(x + 50, y + 50, 50, 50);
		rect3 = new Rectangle(x + 100, y + 50, 50, 50);
		rect4 = new Rectangle(x, y + 50, 50, 50);
	}

	@Override
	public void draw(Graphics g) {
		g.setColor(new Color(101, 243, 182));
	...
	@Override
	public void update() {
		if (rect1.y < rect4.y && rect4.y > 550 || rect1.x > rect4.x && rect3.y > 550 || 
				rect1.y > rect4.y && rect1.y > 550 || rect1.x < rect4.x && rect1.y > 550 /* or hits another block*/) {
			moving = false; // this only works in some orientations
		}
		if (moving == true) {
			//y += 50;
			rect1.y += 50;
